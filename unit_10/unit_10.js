...
let ar1 = ['Hello', 'Teacher', 'Unit 10-1', 28, 10,2021, true, 'or', false];
...
let ar2 = ['Hello', 'Teacher', 'Unit 10-2', 28, 10,2021, true, 'or', false];
...
function f17() {
    ...
    for (let i = 0; i < ar17.length; i++) {
        if (ar17[i] > 3) {
            // a[ar17.length] = ar17[i];
            // out = a;
            // a = ar17[ar17[i].length]
            a += ar17[i];
            out = a.length;
        }
    }
